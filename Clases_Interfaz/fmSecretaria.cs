...
{
    public partial class fmSecretaria : fmMantenimiento
    {
        private CSecretaria OSecretaria;
        private CUsuarios OUsuario; // ----- Para verificar Referencia de integridad
        public fmSecretaria() : base()
        {
        ...
        {
            textBox1.Text = OSecretaria.ValorAtributo("ID_Secret").ToString();
            textBox2.Text = OSecretaria.ValorAtributo("NOMBRE").ToString();
            textBox3.Text = OSecretaria.ValorAtributo("APELLIDO_P").ToString();
            textBox4.Text = OSecretaria.ValorAtributo("APELLIDO_M").ToString();
            textBox5.Text = OSecretaria.ValorAtributo("DIRECCION").ToString();
            textBox7.Text = OSecretaria.ValorAtributo("CELULAR").ToString();
            textBox8.Text = OSecretaria.ValorAtributo("EMAIL").ToString();
            comboBox1.Text = OSecretaria.ValorAtributo("ID_USUARIO").ToString();
        ...
        private void fmSecretaria_Load(object sender, EventArgs e)
        {
